...
export const config = {
     ...
     */
         '/((?!$|insight(?:/|$)|pricing(?:/|$)|despre(?:/|$)|blog(?:/|$)|landing(?:/|$)|contact(?:/|$)|login(?:/|$)|register(?:/|$)|castiga(?:/|$)|shop(?:/|$)|sitemap\\.xml|robots\\.txt|api/stripe/webhook|api/stripe/checkout|api/stripe/sync|api/stripe/portal|api/search(?:/|$)|api/physics(?:/|$)|api/admin(?:/|$)|api/insight(?:/|$)|api/dev(?:/|$)|api/coding-problems(?:/|$)|api/run(?:/|$)|api/run-interactive(?:/|$)|api/mailerlite/webhook(?:/|$)|probleme(?:/|$)|informatica/probleme(?:/|$)|matematica/probleme(?:/|$)|invata(?:/|$)|cursuri(?:/|$)|exerseaza(?:/|$)|simulari-bac(?:/|$)|grile(?:/|$)|biologie/grile(?:/|$)|_next/static|_next/image|favicon.ico|.*\\.(?:svg|png|jpg|jpeg|gif|webp)$).*)',
    ],
}
