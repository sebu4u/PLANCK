...
import { ArrowLeft, PlayCircle, ExternalLink, FileQuestion } from "lucide-react"
...
const youtubeSections = [
    {
        ...
        links: [
            { title: "Kirchhoff’s Rules overview", url: "https://www.youtube.com/watch?v=SKdK_L4jbV0" },
            { title: "Example problem using Kirchhoff’s Rules", url: "https://www.youtube.com/watch?v=Z2QDXjG2ynU" }
        ]
    },
    {
        title: "Oscilații armonice și mișcări oscilatorii",
        links: [
            { title: "Simple Harmonic Motion (lecție introd.)", url: "https://www.youtube.com/watch?v=fkSsV5Wdprs" },
            { title: "SHM mass-spring system (probleme & explicații)", url: "https://www.youtube.com/watch?v=iubb3eFBQ9U" },
            { title: "Simple pendulum (period, frecvență)", url: "https://www.youtube.com/watch?v=1Q15fgz-lUk" },
            { title: "Pendulum practical SHM", url: "https://www.youtube.com/watch?v=eeF4VIFOrP4" }
        ]
    }
];

const problemIds = [
    "M276", "M277", "M278", "M279", "M281", "M282", "M283", "M284", "M285", "M287",
    "M288", "M289", "M290", "M291", "M293", "M294", "M295", "M296", "M297", "M298",
    "M300", "M301", "M302", "M303", "M305", "M306", "M307", "M308", "M309", "M311"
];

export const metadata: Metadata = {
  title: pageTitle("Materiale concurs clasa a XI-a"),
  description: "Materiale de pregătire pentru Concursul Național de Fizică PLANCK – clasa a XI-a.",
}

export default function MaterialsXIPage() {
    return (
            ...
            <main className="pt-32 pb-16 px-4 sm:px-8 lg:px-16 max-w-5xl mx-auto">
                ...
                <div className="text-center mb-16">
                    ...
                    <p className="text-xl text-gray-600 font-medium">
                        Resurse esențiale pentru clasa a XI-a
                    </p>
                </div>

                {/* Section: YouTube Resources (Moved to top since no lessons) */}
