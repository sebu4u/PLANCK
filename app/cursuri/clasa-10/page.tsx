...
const courseData = {
  ...
  chapters: [
    {
      id: 1,
      title: "Termodinamica și ecuația de stare",
      description: "Înțelege comportamentul gazelor și teoria cinetică moleculară",
      duration: "2h 45m",
      lessons: 7,
      free: true,
      completed: false,
      topics: ["Sistem termodinamic", "Ecuația de stare", "Transformări termodinamice", "Gazul ideal"],
    },
    {
      id: 2,
      ...
      free: true,
      completed: false,
      topics: ["Lucrul mecanic", "Energia internă", "Căldura", "Cicluri termodinamice"],
    },
    {
      id: 3,
      ...
      free: true,
      completed: false,
      topics: ["Procese reversibile", "Entropia", "Motoare termice", "Ciclul Carnot"],
    },
    {
      id: 4,
    ...
    },
    {
      ...
      free: true,
      completed: false,
      topics: ["Curentul electric", "Legea lui Ohm", "Rezistența", "Legile lui Kirchhoff"],
    },
    {
      id: 6,
...
export default function Clasa10Page() {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <div className="pt-16">
        {/* Hero Section */}
        <section className="relative py-8 md:py-12 px-4 bg-gradient-to-br from-blue-600 via-purple-600 to-pink-600 text-white overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto">
            ...
            <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
              <div className="order-2 lg:order-1">
                ...
                <p className="text-lg md:text-xl text-blue-100 mb-4 md:mb-6">{courseData.subtitle}</p>
                <p className="text-base md:text-lg text-blue-200 mb-6 md:mb-8 leading-relaxed">{courseData.description}</p>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 mb-6 md:mb-8">
                  ...
                  <div className="text-center">
                    <Users className="w-5 h-5 md:w-6 md:h-6 text-green-400 mx-auto mb-1" />
                    <div className="text-base md:text-lg font-bold">{courseData.students}</div>
                    <div className="text-blue-200 text-xs md:text-sm">Studenți</div>
                  </div>
                  <div className="text-center">
                    <Clock className="w-5 h-5 md:w-6 md:h-6 text-pink-400 mx-auto mb-1" />
                    <div className="text-base md:text-lg font-bold">{courseData.totalDuration}</div>
                    <div className="text-blue-200 text-xs md:text-sm">Durată</div>
                  </div>
                  <div className="text-center">
                    <BookOpen className="w-5 h-5 md:w-6 md:h-6 text-purple-400 mx-auto mb-1" />
                    <div className="text-base md:text-lg font-bold">{courseData.chapters.length}</div>
                    <div className="text-blue-200 text-xs md:text-sm">Capitole</div>
                  </div>
                </div>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 mb-4 md:mb-6">
                  ...
                  <div className="flex items-center gap-2">
                    <span className="text-lg md:text-xl text-blue-200 line-through">{courseData.originalPrice}</span>
              ...
              <div className="relative order-1 lg:order-2">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <Button size="lg" className="bg-white/90 text-blue-600 hover:bg-white rounded-full w-16 h-16 md:w-20 md:h-20">
                      ...
                      <Card key={chapter.id} className="border-blue-200 hover:border-blue-400 transition-colors">
                            ...
                            <div className="flex-1">
                              <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 mb-2">
                                <div className="flex items-center gap-3">
                                  <div className="w-6 h-6 md:w-8 md:h-8 bg-blue-100 rounded-full flex items-center justify-center text-blue-600 font-semibold text-sm md:text-base">
                                    {index + 1}
                                  </div>
                                  <CardTitle className="text-base md:text-lg leading-tight">{chapter.title}</CardTitle>
                                </div>
                                {chapter.free && <Badge className="bg-green-100 text-green-700 text-xs w-fit">Gratuit</Badge>}
                              </div>
                        ...
                        <CardContent className="pt-0 ml-0 sm:ml-11">
                          ...
                          <div className="flex gap-2">
                            {chapter.free ? (
                              <Link href={`/cursuri/clasa-10/${chapter.id}`} passHref legacyBehavior>
                                <Button size="sm" className="bg-gradient-to-r from-blue-600 to-purple-600 text-white text-xs md:text-sm">
              ...
              <div className="space-y-4 md:space-y-6 mt-6 lg:mt-0 lg:sticky lg:top-24 lg:self-start">
                ...
                <Card className="border-blue-200">
                  ...
                  <CardContent className="space-y-2 md:space-y-3">
                    <Button className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white text-sm md:text-base">
                      <Download className="w-4 h-4 mr-2" />
                      Descarcă materiale
                    </Button>
                    <Button variant="outline" className="w-full border-blue-300 hover:border-blue-500 text-sm md:text-base">
