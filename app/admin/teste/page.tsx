...
import { PracticeTestsManager } from "@/components/admin/practice-tests-manager"
...
export default function AdminTestePage() {
  ...
  useEffect(() => {
    async function checkAccess() {
      ...
      const response = await fetch("/api/admin/teste", {
          ...
          <div>
            ...
            <p className="mt-2 text-gray-400">
              {isAdmin
                ...
                : "Doar adminii pot administra testele."}
            </p>
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <main className="mx-auto max-w-[1500px] px-4 pb-12 pt-24">
        ...
        <h1 className="text-3xl font-bold">Teste (/teste)</h1>
        <p className="mt-2 text-gray-400">
          Creează teste curate pe clasă, materie, capitol și dificultate — cu probleme din catalog
          sau proprii.
        </p>
        <div className="mt-7">
          <PracticeTestsManager />
        </div>
      </main>
    </div>
  )
