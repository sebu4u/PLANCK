...
import { MentorsManager } from "@/components/admin/mentors-manager"
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <main className="mx-auto max-w-6xl px-4 pb-12 pt-24">
        <div className="mb-6 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          <div>
            <h1 className="text-3xl font-bold">Administrare mentori</h1>
            <p className="mt-2 max-w-3xl text-sm text-gray-400">
              Leagă un cont existent de un profesor CMS de pe /pregatire. Mentorul poate edita doar profilul lui și
              meditațiile asociate.
            </p>
          </div>
          <div className="flex flex-wrap gap-2">
            <Button
              onClick={() => router.push("/admin/pregatire")}
              variant="outline"
