        ...
        {state === "verify" && (
          <div className="mx-auto flex w-full max-w-5xl justify-center">
            <button
              ...
              className={cn(
                "inline-flex w-full max-w-sm items-center justify-center rounded-full px-5 py-2.5 text-sm font-semibold transition-[transform,box-shadow] sm:px-6 sm:py-3",
                hasSelection
