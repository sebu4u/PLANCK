...
export function ProblemFeedbackBar({
  ...
  return (
    ...
    >
      {state === "verify" && (
        <div className="mx-auto flex w-full max-w-2xl flex-1 items-center gap-3">
          ...
          <button
            ...
            disabled={!hasAnswer}
            className={cn(
              "shrink-0 rounded-full px-6 py-3 text-sm font-semibold transition-[transform,box-shadow]",
              hasAnswer
