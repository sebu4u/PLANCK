...
export function RankEloCard({
  ...
  const getRankColor = (rankName: string) => {
    ...
    if (rankName.includes('Silver')) return 'text-gray-500'
    if (rankName.includes('Gold')) return 'text-yellow-500'
  ...
  return (
    <div className="rounded-xl bg-white border border-gray-200 p-4 hover:border-gray-300 transition-all hover:scale-105 transform origin-center">
      <h3 className="text-base font-semibold text-gray-900 mb-3">Rank & ELO</h3>
      ...
      <div className="flex items-center justify-between mb-3">
        ...
        <div className="text-right">
          <div className="flex items-center gap-1.5 justify-end">
            ...
            <p className="text-3xl font-bold text-gray-900">{elo}</p>
          </div>
      ...
      <div className="mb-3">
        <div className="flex items-center justify-between mb-1">
          <p className="text-xs text-gray-700">Progress to {nextRank}</p>
          <p className="text-xs text-gray-600">+{eloGain} ELO</p>
        </div>
        <Progress
          value={progress}
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <div className="bg-gray-50 rounded-lg p-3 text-center border border-gray-100">
          ...
          <p className="text-xl font-bold text-gray-700 flex items-center justify-center gap-1.5">
