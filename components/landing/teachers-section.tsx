      ...
      <div className="mt-4 flex min-h-0 flex-1 flex-col">
        ...
        <p
          className={cn(
            ...
            SUBJECT_TEXT_CLASS[teacher.subject],
          )}
        >
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <FadeInUp className="mx-auto mb-12 max-w-3xl text-center sm:mb-16">
          ...
          <p className="mt-4 text-base leading-relaxed text-gray-500 sm:text-lg">
            Învață de la cei mai buni olimpici naționali și internaționali. Le vezi sistemul de
            gândire și metodele cu care înțeleg materia eficient — nu doar formulele pe care le
            folosesc.
          </p>
        </FadeInUp>
      </div>
