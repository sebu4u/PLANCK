...
export function HomePageMaiEficientSection() {
  return (
    <section
      ...
      className="bg-white pt-16 pb-0 sm:pt-20 sm:pb-0 lg:pt-24 lg:pb-0"
    ...
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 md:px-12 lg:px-16 xl:px-20">
        <div className="flex flex-col items-stretch gap-10 md:grid md:grid-cols-2 md:gap-12 lg:gap-16">
          <div className="scroll-animate-fade-left order-1 md:min-w-0 md:pt-20 lg:pt-28">
            <h2
          ...
          <div className="scroll-animate-fade-right animate-delay-200 order-2 flex min-h-0 flex-col justify-end md:min-w-0 md:items-end">
            <div className="mx-auto w-full max-w-[280px] overflow-hidden rounded-t-[2rem] shadow-[0_24px_60px_-12px_rgba(15,23,42,0.18)] sm:max-w-[320px] md:mx-0 md:ml-auto md:max-w-[360px] lg:max-w-[400px]">
              <Image
