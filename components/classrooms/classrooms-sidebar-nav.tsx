...
interface ClassroomsSidebarNavProps {
  classrooms: ClassroomSummary[]
}

export function ClassroomsSidebarNav({ classrooms }: ClassroomsSidebarNavProps) {
        ...
        <Sheet>
          ...
          <SheetContent side="right" className="w-full sm:max-w-sm">
            <SheetHeader>
              ...
              <SheetDescription>Creează o clasă nouă sau intră într-una cu un cod.</SheetDescription>
            </SheetHeader>
