...
export function ParentHowItWorksSection() {
  return (
      ...
      <div className="mx-auto flex max-w-6xl flex-col items-start gap-8 px-4 sm:px-6 lg:flex-row lg:gap-6 lg:px-8">
        ...
        <FadeInLeft className="min-w-0 w-full lg:flex-1">
          ...
          <h2 className="mt-5 text-3xl font-black tracking-tight text-gray-900 sm:text-4xl lg:text-[2.65rem] lg:leading-[1.15]">
            Un ritm zilnic pentru copil, fără să cauți profesor după profesor
          </h2>
          <div className="mt-3 h-[3px] w-16 rounded-full bg-[#A3E635]" aria-hidden />
          <p className="mt-6 text-base leading-relaxed text-gray-600 sm:text-lg">
            Copilul alege materia, intră în grupa live și are pregătire în fiecare zi — cu profesor
            real, nu cu un PDF. Dacă ratează ora, rămâne înregistrarea. Între sesiuni lucrează grile
            și exerciții rezolvate video, pe programa de la clasa a 9-a până la a 12-a.
          </p>
          <p className="mt-4 text-base leading-relaxed text-gray-600 sm:text-lg">
            Profesorii sunt olimpici naționali și internaționali: îi arată cum gândesc, nu doar ce
            formulă să pună. Un singur abonament acoperă cele 5 materii. Tu nu trebuie să organizezi
            orarul — noi ținem structura, până când media se mișcă vizibil.
          </p>
        </FadeInLeft>
      </div>
    </section>
