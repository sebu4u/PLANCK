        ...
        <div className="flex max-w-xl flex-col text-center lg:max-w-lg lg:text-left xl:max-w-xl">
          ...
          <FadeInUp delay={0.08}>
            <h1 className="mt-5 text-4xl font-black leading-[1.08] tracking-tight text-gray-900 sm:text-5xl lg:text-[3.25rem] xl:text-6xl">
              Un abonament. Meditații zilnice. Nota de BAC nu se mai lasă pe ultima sută.
            </h1>
          </FadeInUp>

          <FadeInUp delay={0.14}>
            <p className="mt-4 text-base leading-relaxed text-gray-500 sm:text-lg sm:leading-8">
              Simulări și pregătiri BAC, în fiecare zi, ca să recupereze înainte să fie târziu.{" "}
              <strong className="font-semibold text-gray-700">
                {EARLYBIRD_YEARLY_RON} RON/an
              </strong>
              , nu {PARENT_TUTORING_HOUR_MIN_RON}–{PARENT_TUTORING_HOUR_MAX_RON} RON/oră la
              meditații private. Peste{" "}
          ...
          <FadeInUp delay={0.2} className="mt-8">
            <FunnelCtaLink
              ...
              ctaId="parinti_hero_start"
              placement="parinti_hero"
          ...
          <FadeInUp delay={0.24}>
            <p className="mt-2.5 text-sm leading-relaxed text-gray-500 sm:text-[15px]">
              Pentru elevi de clasa a 9-a până la a 12-a. 5 materii într-un abonament.
            </p>
          </FadeInUp>
          ...
          <FadeInUp delay={0.28} className="mt-4">
            <div className="rounded-xl border border-[#EBE8FF] bg-[#F8F7FF] px-4 py-2.5 text-left sm:px-5">
              <p className="text-sm font-semibold leading-snug text-gray-700">
                De la {PARENT_MEDITATION_FROM_RON} RON/meditație. Toate pregătirile înregistrate
                video. Tu vezi progresul.
              </p>
            </div>
          </FadeInUp>
