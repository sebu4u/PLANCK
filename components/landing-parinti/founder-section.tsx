...
export function ParentFounderSection() {
  return (
        ...
        <div className="flex min-w-0 flex-col justify-center px-4 pb-16 pt-8 sm:px-6 sm:pb-20 lg:max-w-2xl lg:px-8 lg:pb-20 lg:pt-20 xl:pl-4">
          <FadeInLeft>
            ...
            <p className="mt-5 text-base leading-relaxed text-zinc-400 sm:text-lg">
              {founder.name} are 18 ani, medalie de argint la Olimpiada Națională de Fizică, și a
              construit PLANCK pentru că nu exista ce își dorea el ca elev: explicații clare, un
              plan real și un profesor care nu obosește. Asta primește și copilul tău.
            </p>
