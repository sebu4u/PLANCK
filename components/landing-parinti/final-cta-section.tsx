...
export function ParentFinalCtaSection({ countdown }: { countdown?: CountdownState }) {
      ...
      <div className="relative mx-auto max-w-3xl px-4 text-center">
        <ScaleIn>
          <h2 className="text-3xl font-black tracking-tight text-gray-900 sm:text-5xl">
            Salvează nota copilului la BAC
          </h2>
        </ScaleIn>

        <FadeInUp delay={0.12} className="mt-4">
          <p className="text-base text-gray-500 sm:text-lg">
            Pregătiri zilnice, un plan clar și earlybird{" "}
            <strong className="text-gray-700">{EARLYBIRD_YEARLY_RON} RON/an</strong> până pe{" "}
            {EARLYBIRD_DEADLINE_LABEL}. Creezi contul de părinte în câteva minute.
          </p>
        </FadeInUp>
        ...
        <FadeInUp delay={0.26} className="mt-10">
          <FunnelCtaLink
            ...
            ctaId="parinti_final_start"
            placement="parinti_final"
