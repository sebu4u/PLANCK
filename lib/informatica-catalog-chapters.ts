...
export const INFORMATICA_CATALOG_CHAPTER_OPTIONS: Record<InformaticaClassValue, string[]> = {
  9: [
    ...
    "Cifrele unui număr",
    "Divizibilitate",
    "Generarea unor șiruri",
    "Baze de numerație",
    "Probleme diverse (algoritmi elementari)",
    "Parcurgerea vectorilor → liste în Python",
    "Ștergeri și inserări de elemente → list.pop(), list.insert()",
    "Verificarea unor proprietăți",
    "Sortarea vectorilor → sort() sau algoritmi manuali",
    "Interclasare",
    "Căutare binară",
    "Probleme cu secvențe",
    "Vectori caracteristici / de frecvență → dicționar sau listă",
    "Probleme diverse (vectori)",
    "Parcurgerea matricelor oarecare → liste de liste",
    "Parcurgerea matricelor pătratice",
    "Generări de matrice",
    "Probleme diverse (matrice)",
    "Probleme diverse (final)",
  ],
  10: [],
  11: [],
  12: [],
