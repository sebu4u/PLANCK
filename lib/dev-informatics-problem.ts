...
export function buildInformaticsProblemRow(body: Record<string, unknown>): {
  ...
  const row: Record<string, unknown> = {
    ...
    hint_1_markdown: nullableTrimmedString(body.hint_1_markdown),
    hint_2_markdown: nullableTrimmedString(body.hint_2_markdown),
    solution_markdown: nullableTrimmedString(body.solution_markdown),
