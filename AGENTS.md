...
- Do not commit internal plan docs unless explicitly requested.
...
- `pnpm lint`/`next lint` may be stale under Next 16; report it as blocked if it fails for tooling reasons.
